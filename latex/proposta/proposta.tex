...
Llamaremos \emph{hojas} a las aristas adjuntas de los v\'ertices inputs y \emph{ra\'iz} a la arista adjunta del v\'ertice output.
De tal manera que las aristas restantes las llamaremos \emph{aristas interiores}. Podemos observar que existe una direcci\'on clara en cada \'arbol, desde las hojas hasta la ra\'iz.
