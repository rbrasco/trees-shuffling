...
En este apartado vamos a introducir el producto tensorial entre conjuntos dendroidales gracias al producto tensorial de Boardman--Vogt.
...
\begin{defi}
    ...
    $$
    Sabemos que este producto tensorial es cerrado gracias a la teor\'ia general de categor\'ias [Kel82], y el conjunto de $T$-d\'endrices del hom interno viene definido por
    $$
