...
$$
    \begin{tikzpicture}
        [tri/.style = {align=center, regular polygon, regular polygon sides=3,
        ...
        (2) -- (4)
        (2) -- (5);
        \node (tri1) [tri] at (0,2.3) {$S$};
        \node (label) at (-1,0) {$R_1$};
        \node (tri2) [tri, inner sep=0.1mm] at (1.86,4.433) {$T$};
        \node (tri3) [tri, inner sep=0.1mm] at (0,4.433) {$T$};
        \node (tri4) [tri, inner sep=0.1mm] at (-1.86,4.433) {$T$};
    \end{tikzpicture}
    \begin{tikzpicture}
        \node (1) at (-1,0) {};
        \node (1) at (1,0) {};
